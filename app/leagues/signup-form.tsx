...
export function LeagueForm() {
  ...
  return (
    <form className="signup-form" onSubmit={submit}>
      ...
      <label>League interest<select name="league" defaultValue="Any league"><option>Any league</option><option>Mixed league</option><option>Scratch league</option><option>Women&apos;s league</option><option>Social league</option><option>Senior league</option></select></label>
